...
* `./Data_extended/`: This folder contains 27 data sets from Middlebury official test datasets. It includes test data and disparity map which are standard images.
